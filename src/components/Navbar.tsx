...
export default function Navbar() {
  ...
  return (
    <header className="bg-white/85 dark:bg-[#0f172a]/85 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800 sticky top-0 z-40 shadow-xs transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="flex items-center justify-between h-16 gap-4 sm:gap-6">
          {/* Brand Logo */}
          <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 via-indigo-600 to-cyan-500 text-white flex items-center justify-center font-bold text-lg shadow-md shadow-indigo-500/25 group-hover:scale-105 group-hover:rotate-3 transition-all duration-300">
              <Ticket className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <span className="font-black text-sm sm:text-base text-slate-900 dark:text-white tracking-tight flex items-center gap-1.5">
                <span>TicketPulse</span>
                <span className="text-[10px] uppercase font-black px-1.5 py-0.5 rounded-md bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 dark:from-indigo-500/20 dark:to-cyan-500/20 text-indigo-600 dark:text-cyan-400 border border-indigo-200/50 dark:border-cyan-500/30">
                  NextGen
                </span>
              </span>
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 transition-all duration-200 hover:scale-105 active:scale-95 group relative"
            ...
            <div className="pl-2 sm:pl-2.5 border-l border-slate-200 dark:border-slate-800 flex items-center gap-2">
              {isAuthenticated && currentUser ? (
                <>
                  <Link
                    href="/profile"
                ...
                <Link
                  href="/login"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-bold transition-all"
                >
        ...
        {isAuthenticated && currentUser && mobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-slate-100 dark:border-slate-800 space-y-2">
